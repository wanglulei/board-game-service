...
/**
　　* @Description: 临时用，接管原有starbaba中的功能
　　*
　　*
　　*
　　*/
...
public class JedisUtils {
    ...
    public void setPool(Pool<Jedis> pool){
        JedisUtils.pool=pool;
    }

    /**
     * <pre>
     * 获取jedis连接资源，如果使用 该方法获取 jedis，需要在finally中return回池里面
     * such as :
     * Jedis j = null;
     * try {
    ...
    @Deprecated
    public static Object exec(String method, Object... param) {
        Jedis jedis = null;
        try {
            jedis = getResource();
            return MethodUtils.invokeMethod(jedis, method, param);
        } catch (Exception e) {
            log.error("exec {0} error:" + e.getMessage(), e);
            // e.printStackTrace();
        } finally {
    ...
    public static long setrange(String key, long offset, String value) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.setrange falid", e);
        }
        return result;
    }
    ...
    public static String getrange(String key, long startOffset, long endOffset) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.getrange falid", e);
        }
        return result;
    }
    ...
    public static long sadd(String key, String... members) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.sadd falid", e);
        }
        return result;
    }
    ...
    public static long srem(String key, String... members) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.srem falid", e);
        }
        return result;
    }
    ...
    public static long rpush(String key, String... values) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.rpush falid", e);
        }
        return result;
    }
    ...
    public static long zrem(String key, String... members) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.zrem falid", e);
        }
        return result;
    }
    ...
    public static Set<String> zrevrangeByScore(String key, double max, double min) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.zrevrangeByScore falid", e);
        }
        return result;
    }
    ...
    public static List<String> scan(String pattern, int count) {
        ...
        try {
            ...
            returnBrokenResource(jedis);
            log.error("JedisCache.scan falid", e);
        }
        return list;
    }
